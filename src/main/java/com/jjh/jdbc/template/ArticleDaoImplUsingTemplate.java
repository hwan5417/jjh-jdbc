...
import com.jjh.jdbc.raw.Article;
import com.jjh.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/2015041054db?user=jaehwan&password=wjdwoghks1208");
